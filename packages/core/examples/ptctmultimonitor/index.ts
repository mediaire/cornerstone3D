...
const volumeIds = {
  ...
  study2: {
    ct: `${volumeLoaderScheme}:CT_VOLUME_STUDY2`,
    pt: `${volumeLoaderScheme}:PT_VOLUME_STUDY2`,
  },
  study3: {
    ct: `${volumeLoaderScheme}:CT_VOLUME_STUDY3`,
    pt: `${volumeLoaderScheme}:PT_VOLUME_STUDY3`,
  },
};
...
const toolGroupIds = {
  ...
  study2: {
    ct: 'CT_TOOLGROUP_STUDY2',
    pt: 'PT_TOOLGROUP_STUDY2',
    fusion: 'FUSION_TOOLGROUP_STUDY2',
    mip: 'MIP_TOOLGROUP_STUDY2',
  },
  study3: {
    ct: 'CT_TOOLGROUP_STUDY3',
    pt: 'PT_TOOLGROUP_STUDY3',
    fusion: 'FUSION_TOOLGROUP_STUDY3',
    mip: 'MIP_TOOLGROUP_STUDY3',
  },
};
...
const viewportIds = {
  ...
  study2: {
    CT: {
      AXIAL: 'CT_AXIAL_S2',
      SAGITTAL: 'CT_SAGITTAL_S2',
      CORONAL: 'CT_CORONAL_S2',
    },
    PT: {
      AXIAL: 'PT_AXIAL_S2',
      SAGITTAL: 'PT_SAGITTAL_S2',
      CORONAL: 'PT_CORONAL_S2',
    },
    FUSION: {
      AXIAL: 'FUSION_AXIAL_S2',
      SAGITTAL: 'FUSION_SAGITTAL_S2',
      CORONAL: 'FUSION_CORONAL_S2',
    },
    PETMIP: { CORONAL: 'PET_MIP_CORONAL_S2' },
  },
  study3: {
    CT: {
      AXIAL: 'CT_AXIAL_S3',
      SAGITTAL: 'CT_SAGITTAL_S3',
      CORONAL: 'CT_CORONAL_S3',
    },
    PT: {
      AXIAL: 'PT_AXIAL_S3',
      SAGITTAL: 'PT_SAGITTAL_S3',
      CORONAL: 'PT_CORONAL_S3',
    },
    FUSION: {
      AXIAL: 'FUSION_AXIAL_S3',
      SAGITTAL: 'FUSION_SAGITTAL_S3',
      CORONAL: 'FUSION_CORONAL_S3',
    },
    PETMIP: { CORONAL: 'PET_MIP_CORONAL_S3' },
  },
};
...
const synchronizerIds = {
  ...
  study2: {
    axialCamera: 'AXIAL_CAMERA_SYNC_S2',
    sagittalCamera: 'SAGITTAL_CAMERA_SYNC_S2',
    coronalCamera: 'CORONAL_CAMERA_SYNC_S2',
    ctVoi: 'CT_VOI_SYNC_S2',
    ptVoi: 'PT_VOI_SYNC_S2',
    fusionVoi: 'FUSION_VOI_SYNC_S2',
  },
  study3: {
    axialCamera: 'AXIAL_CAMERA_SYNC_S3',
    sagittalCamera: 'SAGITTAL_CAMERA_SYNC_S3',
    coronalCamera: 'CORONAL_CAMERA_SYNC_S3',
    ctVoi: 'CT_VOI_SYNC_S3',
    ptVoi: 'PT_VOI_SYNC_S3',
    fusionVoi: 'FUSION_VOI_SYNC_S3',
  },
};
...
const studyConfigs = [
  ...
  {
    studyId: ThirdStudyID,
    studyKey: 'study3',
    ctSeriesUID:
      '1.3.6.1.4.1.9328.50.17.135334071755755347832616394678950029105',
    ptSeriesUID:
      '1.3.6.1.4.1.9328.50.17.171167119696208952720976351719238820467',
  },
];
...
['study1', 'study2', 'study3'].forEach((studyKey) => {
