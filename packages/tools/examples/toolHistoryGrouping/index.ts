...
// ======== Set up page ======== //
setTitleAndDescription(
  'Tool History Grouping',
  "Demonstrate undo/redo grouped actions on tools. Notice that in most cases this should be done programmatically and the user shouldn't have to be aware of this api."
);
